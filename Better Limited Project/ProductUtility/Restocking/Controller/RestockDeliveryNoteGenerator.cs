...
{
    public class RestockDeliveryNoteGenerator
    {
        private readonly string _fileName;
        private readonly string _location;
        private readonly RestockDelivery _restockDelivery;

        public RestockDeliveryNoteGenerator(RestockDelivery restockDelivery)
        {
            _restockDelivery = restockDelivery;
            _fileName = "restock delivery note.pdf";
        ...
        private void CreatePage(Document doc)
        {
            ...
            var paymentReceiptParagraph = headerText.AddParagraph("Restock Delivery");
            ...
            string date = _restockDelivery.DepartureScheduledOn.ToString("D");
            string couriers = string.Join(", ", _restockDelivery.Couriers.Select(c => c.Name));
            ...
            row.Cells[1].AddParagraph("Restock Request No.");
            row.Cells[1].Format.Alignment = ParagraphAlignment.Left;
            row.Cells[2].AddParagraph("Retail Store");
            row.Cells[2].Format.Alignment = ParagraphAlignment.Left;
            row.Cells[3].AddParagraph("Full Address");
