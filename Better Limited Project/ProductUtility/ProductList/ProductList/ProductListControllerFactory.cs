...
namespace Better_Limited_Project.ProductUtility.ProductList.ProductList
{
    ...
    {
        public static IProductListController Generate(FormController formController)
        {
            var department = StaffRepository.GetStaff(LoginSession.GetSession().StaffId).Department;

            return department switch
            {
                Department.Sales or Department.Inventory => new ProductListController(formController),
