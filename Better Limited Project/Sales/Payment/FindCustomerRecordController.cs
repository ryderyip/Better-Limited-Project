...
{
    public class FindCustomerRecordController
    {
        ...
        public FindCustomerRecordController(FormController formController)
        {
        ...
        public void OpenForm()
        {
            ...
            form.CustomerRecordRetrieved += (_, c) => NextClicked?.Invoke(this, c);
