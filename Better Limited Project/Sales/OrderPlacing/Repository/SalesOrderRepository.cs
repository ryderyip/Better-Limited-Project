    ...
    public class SalesOrderRepository : IRepository<SalesOrder>, IRepositoryInsert<SalesOrder>
    {
        ...
        public IEnumerable<SalesOrder> GetAll()
        {
            var command = new MySqlCommand(
                @"select id, customer_id, retail_store_id, created_by_staff_id, created_on from sales_order;");
        ...
        {
            var command = new MySqlCommand(
                @"insert into sales_order (id, customer_id, retail_store_id, created_by_staff_id, created_on) 
                        value (0, @customerId, @retailStoreId, @createdByStaffId, now());
